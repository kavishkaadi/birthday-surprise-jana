const CACHE='birthday-surprise-v9';
const ASSETS=['./','./index.html','./manifest.webmanifest','./assets/icon.svg','./assets/photo1.jpg','./assets/photo2.jpg','./assets/final-photo-optimized.jpg'];
